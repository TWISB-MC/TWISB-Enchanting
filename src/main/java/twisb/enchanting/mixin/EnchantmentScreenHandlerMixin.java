...
public abstract class EnchantmentScreenHandlerMixin extends ScreenHandler {
    ...
    @Redirect(
            ...
            at = @At(value = "INVOKE", target = "Lnet/minecraft/enchantment/EnchantmentHelper;generateEnchantments(Lnet/minecraft/util/math/random/Random;Lnet/minecraft/item/ItemStack;ILjava/util/stream/Stream;)Ljava/util/List;")
    )
    private List<EnchantmentLevelEntry> redirectGenerateEnchantments(Random random, ItemStack stack, int level, Stream<RegistryEntry<Enchantment>> possibleEnchantments) {
        return BetterEnchantmentHelper.generateEnchantments(this.random, stack, level, this.inventory.getStack(2), possibleEnchantments);
    }
