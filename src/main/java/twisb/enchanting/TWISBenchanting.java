...
public class TWISBenchanting implements ModInitializer {
	...
	// Catalysts
	public static final Item CATALYST_PLENTIFUL = new Item(new Item.Settings().rarity(Rarity.RARE));
	public static final Item CATALYST_SMOLDERING = new Item(new Item.Settings().rarity(Rarity.RARE));
	public static final Item CATALYST_ABYSSAL = new Item(new Item.Settings().rarity(Rarity.RARE));
	public static final Item CATALYST_EXPLOSIVE = new Item(new Item.Settings().rarity(Rarity.RARE));
	public static final Item CATALYST_DIVINE = new Item(new Item.Settings().rarity(Rarity.RARE));
	public static final Item CATALYST_PRESERVING = new Item(new Item.Settings().rarity(Rarity.RARE));
	public static final Item CATALYST_ENHANCING = new Item(new Item.Settings().rarity(Rarity.RARE));
...
//	public static final Item CATALYST_STURDY = new Item(new FabricItemSettings().rarity(Rarity.RARE));
	...
	public void onInitialize() {
		...
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "plentiful_catalyst"), CATALYST_PLENTIFUL);
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "smoldering_catalyst"), CATALYST_SMOLDERING);
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "abyssal_catalyst"), CATALYST_ABYSSAL);
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "explosive_catalyst"), CATALYST_EXPLOSIVE);
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "divine_catalyst"), CATALYST_DIVINE);
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "preserving_catalyst"), CATALYST_PRESERVING);
		Registry.register(Registries.ITEM, Identifier.of("twisb-enchanting", "enhancing_catalyst"), CATALYST_ENHANCING);
