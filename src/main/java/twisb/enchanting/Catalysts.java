...
public class Catalysts {
    ...
    public static final HashMap<Item, TagKey<Enchantment>> MAPPINGS = new HashMap<>() {
        {
...
//    public static final HashMap<Item, List<RegistryKey<Enchantment>>> MAPPINGS = new HashMap<>() {
//        {
